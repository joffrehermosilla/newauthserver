package backend.joffre.twofactor;
...
public class TwoFactorHandler implements AuthenticationSuccessHandler {
	...
	private final Authentication auth_token = new AnonymousAuthenticationToken("anonymous", "anonymous",
			AuthorityUtils.createAuthorityList("ROLE_ANONYMOUS", "ROLE_TWO_F"));
