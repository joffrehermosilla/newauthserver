...
import backend.joffre.federated.FederatedIdentityAuthenticationSuccessHandler;
import backend.joffre.federated.FederatedIdentityConfigurer;
...
public class AuthorizationSecurityConfig {
	...
	/*
	 * @Bean public UserDetailsService userDetailsService(){ UserDetails userDetails
	 * = User.withUsername("user") .password("{noop}user") .authorities("ROLE_USER")
	 * .build(); return new InMemoryUserDetailsManager(userDetails); }
	 */
	/*
	 ...
	 * .clientSettings(clientSettings()) .build(); return new
